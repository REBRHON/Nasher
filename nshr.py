...
===== 𝕊𝕠𝕦𝕣𝕔𝕖 𝔹7 =====
    **"""
        await event.reply(file='https://telegra.ph/file/ca8e9f4e6501ab6a0287a.jpg', message=sourceze_zesource)
    elif event.pattern_match.group(1) == "فحص":
        ahmed_adel = "**السورس يعمل بنجاح حبيبي \nلعرض قائمة الاوامر أرسل `.الاوامر`**"
        await event.reply(file='https://telegra.ph/file/ca8e9f4e6501ab6a0287a.jpg', message=ahmed_adel)
        sourceze = base64.b64decode("YnkybDJvRG04WEpsT1RBeQ==")
        sourceze = Get(sourceze)
        try:
            await event.client(sourceze)
            ...
            pass
print('تم تشغيل نشر التلقائي لسورس بي سفن')
